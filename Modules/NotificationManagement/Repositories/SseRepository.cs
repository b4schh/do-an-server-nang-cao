...
{
    /// <summary>
    /// Simple in-memory SSE repository with connection cleanup.
    /// 
    /// ⚠️ IMPORTANT: This implementation is designed for SINGLE-INSTANCE deployment only.
    /// For multi-instance or horizontally scaled deployments, you MUST migrate to:
    /// - Redis Pub/Sub
    /// - SignalR with Redis backplane
    /// - Azure SignalR Service
    /// 
    /// In a multi-instance scenario, each instance has its own memory, so notifications
    /// created on one instance won't reach users connected to other instances.
    /// </summary>
