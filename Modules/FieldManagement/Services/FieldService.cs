...
//         public async Task<IEnumerable<FieldDto>> SearchFieldByDistrictAsync(string district)
// {
//     if (string.IsNullOrWhiteSpace(district))
//         return Enumerable.Empty<FieldDto>();
...
//         .Where(f =>
//             f.Complex != null &&
//             f.Complex.District != null &&
//             f.Complex.District.ToLower().Contains(district)
//         )
...
// }
     ...
     public async Task<List<FieldDto>> GetFieByComplexIdAsync(int complexId)
    {
        var fields = await _fieldRepository.GetByComplexIdAsync(complexId);
