...
namespace FootballField.API.Modules.ComplexManagement.Services
{
    public interface IComplexService
    {
        ...
        Task<List<FieldPricing>> GetPricingAsync(
        int complexId,
        TimeSpan time
    );
        Task<List<ComplexImageDto>> GetImagesAsync(int complexId);
        ...
        Task<IEnumerable<ComplexDto>> SearchByDistrictAsync(string district);
        Task<ComplexWithFieldsDto?> GetComplexWithFieldsAsync(int id);
         Task<IEnumerable<ComplexDto>> SearchByKeywordAsync(string keyword);
        Task<IEnumerable<ComplexDto>> GetComplexesByOwnerIdAsync(int ownerId);
        Task<bool> ValidateOwnerRoleAsync(int ownerId);
        Task<List<ComplexDto>> GetSuggestionByDistrictAsync(
    string district,
    ...
    int limit
        ...
        Task<IEnumerable<ComplexDto>> SearchComplexesAsync(
            ...
            Task<ComplexFullDetailsDto?> GetByNameAsync(string name);
    }
