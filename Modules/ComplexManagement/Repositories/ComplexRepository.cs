...
namespace FootballField.API.Modules.ComplexManagement.Repositories
{
    public class ComplexRepository : GenericRepository<Complex>, IComplexRepository
    {
        ...
        public async Task<IEnumerable<Complex>> GetComplexesWithDetailsForSearchAsync()
        {
         ...
         public IQueryable<Complex> Query()
    {
        return _context.Complexes;
    }


    public async Task<List<Complex>> SearchByDistrictAsync(string district)
{
    ...
    return await _dbSet
        .Where(c =>
            ...
            c.IsActive &&
            c.Province != null &&
            c.Province.ToLower().Contains(district)
        )
        .OrderBy(c => c.Name)
        .ToListAsync();
}

public async Task<List<Complex>> SearchByKeywordAsync(string keyword)
{
    ...
    return await _dbSet
        .Where(c =>
            ...
            (
                ...
                (c.Province != null && c.Province.ToLower().Contains(keyword)) 
