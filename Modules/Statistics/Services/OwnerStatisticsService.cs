...
namespace FootballField.API.Modules.Statistics.Services
{
    public class OwnerStatisticsService : IStatisticsService
    {
        ...
        private List<RevenueSummaryDto> GroupByDaily(List<Booking> bookings, DateTime startDate, DateTime endDate)
        {
            ...
            for (var date = startDate.Date; date <= endDate.Date; date = date.AddDays(1))
            {
                var dayBookings = grouped.ContainsKey(date) ? grouped[date] : new List<Booking>();
        ...
        private List<RevenueSummaryDto> GroupByWeekly(List<Booking> bookings, DateTime startDate, DateTime endDate)
        {
            var grouped = bookings
                .GroupBy(b => new
                {
            ...
            while (currentWeekStart <= endDate.Date)
            {
                ...
                var weekBookings = grouped.ContainsKey(weekKey) ? grouped[weekKey] : new List<Booking>();
        ...
        private List<RevenueSummaryDto> GroupByMonthly(List<Booking> bookings, DateTime startDate, DateTime endDate)
        {
            var grouped = bookings
            ...
            for (int month = 1; month <= 12; month++)
            {
                ...
                var monthBookings = grouped.ContainsKey(monthKey) ? grouped[monthKey] : new List<Booking>();
        ...
        private List<RevenueSummaryDto> GroupByQuarterly(List<Booking> bookings, DateTime startDate, DateTime endDate)
        {
            var grouped = bookings
                .GroupBy(b => new
                {
            ...
            for (int quarter = 1; quarter <= 4; quarter++)
            {
                ...
                var quarterBookings = grouped.ContainsKey(quarterKey) ? grouped[quarterKey] : new List<Booking>();
        ...
        private List<RevenueSummaryDto> GroupByYearly(List<Booking> bookings, DateTime startDate, DateTime endDate)
        {
            var grouped = bookings
            ...
            for (int year = currentYear - 2; year <= currentYear; year++)
            {
                ...
                var yearBookings = grouped.ContainsKey(yearKey) ? grouped[yearKey] : new List<Booking>();
