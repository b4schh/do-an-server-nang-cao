...
namespace DoAn.Core.Application.Services.Review
{
    public class ReviewService : IReviewService
    {
        ...
        public async Task<ReviewDto> CreateReviewAsync(int customerId, CreateReviewDto createReviewDto)
        {
            ...
            // 5. Tạo review
            var review = _mapper.Map<ReviewEntity>(createReviewDto);
        ...
        private OwnerReviewDto MapToOwnerReviewDto(ReviewEntity review)
        {
