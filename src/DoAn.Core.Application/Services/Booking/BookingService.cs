...
namespace DoAn.Core.Application.Services.Booking
{
    public class BookingService : IBookingService
    {
        ...
        public async Task<BookingDto> CreateBookingAsync(int customerId, CreateBookingDto dto)
        {
            ...
            var booking = new DoAn.Core.Domain.Entities.Booking
            {
                FieldId = dto.FieldId,
            ...
            try
            {
                var ownerNotification = new NotificationEntity
                {
                    UserId = ownerId,
                    SenderId = customerId,
        ...
        private async Task<BookingDto> MapToBookingDto(DoAn.Core.Domain.Entities.Booking booking)
        {
        ...
        private BookingDto MapToBookingDtoSync(DoAn.Core.Domain.Entities.Booking booking)
        {
