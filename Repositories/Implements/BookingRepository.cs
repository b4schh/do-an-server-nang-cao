...
namespace FootballField.API.Repositories.Implements
{
    public class BookingRepository : GenericRepository<Booking>, IBookingRepository
    {
        ...
        public async Task<List<int>> GetBookedTimeSlotIdsForComplexAsync(int complexId, DateTime date)
        {
            return await _context.Bookings
                .Where(b => b.Field.ComplexId == complexId && b.BookingDate.Date == date.Date)
